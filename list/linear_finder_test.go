...
func TestFinderLinearSearch(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			actualResult: func() int64 {
				return newLinearFinder[int64]().search(newTestArrayList(100), 4)
			},
			expectedResult: 4,
		},
		{
			...
			actualResult: func() int64 {
				return newLinearFinder[int64]().search(newTestArrayList(100), 105)
			},
			expectedResult: -1,
		},
		{
			...
			actualResult: func() int64 {
				return newLinearFinder[int64]().search(newTestArrayList(0), 1)
			},
			expectedResult: -1,
		},
	}
